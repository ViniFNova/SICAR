os arquivos devem seguir a seguinte organização:
...
renemei os limites municiapis para "MG_Municipios_2024" .cst, .dbf, .prj, .shp e .shx
agora é só executar o separar_camadas.py e escolher a seperação das APPs ou RL
